...
const BlurDown = () => {
  return (
    <div className='absolute top-0 left-0 right-0 w-full z-[5] pointer-events-none transition-[transform,height] duration-[1000ms] ease-[cubic-bezier(0.55,0,0.1,1)] transform translate-y-[-30%] origin-top-left h-[280%]'>
