...
// SVG paths for the text outline
...
<defs>
<clipPath id="clip0_2172_13730">
<rect width="2484.1" height="207.4" fill="white"/>
</clipPath>
</defs>
</svg>
`;
...
// Particle class to manage particle state
class Particle {
  targetX: number;
  targetY: number;
  x: number;
...
// Utility function to create particles from SVG paths
function createParticlesFromPaths(
...
export default function AnimatedText() {
  ...
  useEffect(() => {
    ...
    // Create particles from paths
    const newParticles = createParticlesFromPaths(
      pathElements,
      svgWidth,
      svgHeight
    );
